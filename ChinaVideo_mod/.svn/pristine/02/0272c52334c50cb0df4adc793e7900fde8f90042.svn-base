...
public class DownRunwayManager {
	public static DownRunwayManager instance = null;
...
//	private SmilyParse smilyparse;
	...
	public static DownRunwayManager getInstance() {
		if (instance == null)
			instance = new DownRunwayManager();
		return instance;
	}
