...
public class APP extends Application {
	public static int IS_DEMO = 2 ; //0内网 1外网 2外网测试 
	
	public static  String PATH_NEIWANG = "http://60.174.249.98:8002/api/rpc/pc.php";//php服务器
	public static  String GIFT_PATH = "http://static.0058.com/static/img/gift/mobile/";//礼物图片地址
	public static  String DISC_PATH = "http://60.174.249.98:8000/static/img/app/faxian/";// 发现测试服图片地址
	public static  String CAR_PATH = "http://static.0058.com/static/img/mount/mobile/sit_"; // 座驾新地址
	...
	public static void init() {
		if(IS_DEMO == 0){
			...
			DISC_PATH = "http://60.174.249.98:8002/static/img/app/faxian/";// 发现测试服图片地址
			CAR_PATH =  "http://60.174.249.98:8002/static/img/mount/mobile/sit_";// 发现测试服图片地址
		}else if(IS_DEMO == 1){
