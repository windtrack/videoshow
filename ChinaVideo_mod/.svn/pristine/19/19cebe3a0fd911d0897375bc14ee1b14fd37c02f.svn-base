...
public class AnchorZhuboFragment extends Fragment {
	...
	private GetRedBeansUtil getRedBeansUtil;
...
//		Log.e("unfind", "开始每隔三分钟获取一次红豆");
		Threadstate = true;
		getRedBeansUtil = new GetRedBeansUtil();
		getRedBeansUtil.getRedBeansTask(
...
//	}
	...
	public void onStop() {
		super.onStop();
//		Log.e("unfind", "进入AnchorZhuboFragment的onStop生命周期方法");
