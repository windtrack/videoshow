...
//						m_photoPath
	...
	public void onClick(View v) {
		...
		case R.id.anchor_home:
		{
			...
			GlobalData.getInstance(AnchorCenterActivity.this).mCurRoomIdFormAnchorCenter = room_id ;
			GlobalData.getInstance(AnchorCenterActivity.this).mJumpFormAnchorCenter = true ;
			Intent in = new Intent(this, LiveRoomActivity.class);
			in.putExtra("room_id", room_id);
			this.startActivity(in);
//			this.startActivityForResult(in, 1024);
//			setResult(99);
		}
