...
import com.zhipu.chinavideo.ImageDetailsActivity;
...
public class ZoomImageView extends View {
	...
	private ImageDetailsActivity act;

	public void setAct(ImageDetailsActivity act) {
		this.act = act;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			lastXMove = -1;
			lastYMove = -1;
			long curTime = event.getEventTime(); // 控制单次点击
			if (curTime - curTouchTime < 200) {
		...
		case MotionEvent.ACTION_DOWN:
			curTouchTime = event.getDownTime();
			break;
		default:
			break;
		}
