...
//				String s = Utils.get_mainpageranchorlist();
				String s = Utils.addRpcEvent(RpcEvent.GetHallInfo);
...
//						handler.sendEmptyMessage(4);
						handler.sendEmptyMessage(HandlerCmd.HandlerCmd_LoadFailed);
					}
...
//					handler.sendEmptyMessage(3);
	...
	private UIHandler handler = new UIHandler(Looper.getMainLooper(), new IHandler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case HandlerCmd.HandlerCmd_LoadFailed:
...
//					anchor_list = gd.getmHallInfo().anchor_list;
					...
					// .getActivity());
					advertiseAdapter = new AdvertiseAdapter(advertise_list, MainPageFragment.this
					...
					initCirclePoint();
					// sendEmptyMessage(5);
					maipager_list_adapter = new TypePagerAdapter(MainPageFragment.this
							.getParentFragment().getActivity(), anchor_list);
				...
				case HandlerCmd.HandlerCmd_RPC_Failed:
					...
					break;
				case HandlerCmd.HandlerCmd_RPC_Exception:
					pullToRefreshListView.onRefreshComplete();
					break;
				case 5:
